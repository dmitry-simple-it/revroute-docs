...
description: "Узнайте, как использовать Dub для программного создания, обновления и удаления ссылок в масштабе."
---

Ссылки — это основа [Dub](https://dub.co).

Всё в Dub начинается со ссылки. Будь то:
...
Вы можете использовать различные [SDK Dub](/docs/sdks/overview) для программного управления ссылками.
...
Вы можете использовать либо `linkId`, либо `externalId` с префиксом `ext_`, который является уникальным идентификатором ссылки в вашей базе данных для связи с ссылкой в системе Dub.
