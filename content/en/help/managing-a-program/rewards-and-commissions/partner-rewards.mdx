...
<video src="https://s3.revroute.ru/dub-public/assets/cms/dub-partners-custom-rewards.mp4"
    loop
    autoPlay
    muted
    playsInline
...
![Default group rewards](https://s3.revroute.ru/dub-public/assets/cms/group-rewards-default.png)
...
![Initial create sale reward state](https://s3.revroute.ru/dub-public/assets/cms/reward-create-intial-01.png)
...
On Revroute, you can also set specific requirements for reward completion and can even reward a different type (flat rate or percentage), amount, and duration when they are met. They are available for sale and lead rewards only, and allow you to set conditions like the following:
...
![Initial create sale reward state](https://s3.revroute.ru/dub-public/assets/cms/create-reward-condition-02.png)
...
![Initial create sale reward state](https://s3.revroute.ru/dub-public/assets/cms/create-reward-condition-filled-02.png)
...
![Custom reward description](https://s3.revroute.ru/dub-public/assets/cms/custom-desc-01.png)
...
![Editing the reward description](https://s3.revroute.ru/dub-public/assets/cms/custom-desc-02.png)
...
![Editing the reward tooltip](https://s3.revroute.ru/dub-public/assets/cms/custom-desc-03.png)
...
![Reward preview tooltip hover](https://s3.revroute.ru/dub-public/assets/cms/custom-desc-04.png)
...
![Reward preview](https://s3.revroute.ru/dub-public/assets/cms/reward-preview-01.png)
...
![Global Boost condition example](/images/partners-overview/create-reward-geo-condition.png)
...
![Product Spotlight condition example](https://s3.revroute.ru/dub-public/assets/cms/condition-example-02.png)
...
![The Climb condition example](https://s3.revroute.ru/dub-public/assets/cms/condition-example-03.png)
...
![Staggered rewards example](https://s3.revroute.ru/dub-public/assets/cms/staggered-rewards-03.png)
...
![The Climb condition example](https://s3.revroute.ru/dub-public/assets/cms/condition-example-04.png)
...
![Partner profile page group history.](/images/partners-overview/group-reward-update-logs.png)
