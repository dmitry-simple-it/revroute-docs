...
![Branding page within your dashboard](https://assets.dub.co/cms/program-branding-tab2.png)
...
![Brand page within your dashboard](https://assets.dub.co/cms/lander-edit1.jpg)
...
![Brand page within your dashboard](https://assets.dub.co/cms/lander-insertblock1.jpg)

### Text

Best used for text and paragraph content. This section also uses markdown formatting when editing.

![Adding text content](https://assets.dub.co/cms/lander-insert-text.jpg)

### Image

For adding product screenshots and other complementary visuals to the program.

![Adding image content](https://assets.dub.co/cms/lander-insert-image.jpg)

### Files

For adding product screenshots and other complementary visuals to the program.

![Adding files](https://assets.dub.co/cms/lander-insert-file.jpg)
...
![Adding accordion content](https://assets.dub.co/cms/lander-insert-accordion.jpg)

### Earnings calculator

Give your partners a sense of how much they can earn, based on your default rewards.

![Adding earnings calculator](https://assets.dub.co/cms/lander-insert-calculator.jpg)
...
![Generate lander AI button](https://assets.dub.co/cms/generate-lander-ai-button.png)
...
![Publish button](https://assets.dub.co/cms/lander-publish-2.png)
