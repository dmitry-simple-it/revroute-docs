...
![Аналитика конверсий](https://s3.revroute.ru/dub-public/assets/blog/introducing-dub-conversions.webp)
...
Затем вам потребуется сгенерировать [публичный ключ](/docs/api-reference/authentication#publishable-keys-клиентское-отслеживание-конверсий) в вашем рабочем пространстве Revroute для отслеживания конверсий на стороне клиента.
