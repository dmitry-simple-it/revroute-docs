...
[Интеграция Revroute с HubSpot](https://dub.co/integrations/hubspot) позволяет отслеживать события конверсий непосредственно из HubSpot.
...
Наконец, установите [интеграцию HubSpot с Revroute](https://app.dub.co/integrations/hubspot) в вашем рабочем пространстве.
