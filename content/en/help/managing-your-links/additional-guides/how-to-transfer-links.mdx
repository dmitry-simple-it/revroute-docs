...
description: "Learn how to transfer your Dub default short links from one workspace to another."
...
- You can only transfer [default Dub domains](/help/managing-your-links/custom-domains/default-dub-domains) (e.g. \`dub.sh\`, \`chatg.pt\`, \`spti.fi\`, \`amzn.id\`, etc.) between workspaces. If you want to transfer a custom domain link, you'll need to [transfer the domain](/help/managing-your-links/custom-domains/how-to-transfer-domains) itself to the new workspace.
