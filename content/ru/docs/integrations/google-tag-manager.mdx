...
description: "Узнайте, как отслеживать события конверсий продаж с помощью Google Tag Manager и Revroute"
...
[Интеграция Revroute с Google Tag Manager](https://revroute.ru/integrations/google-tag-manager) позволяет отслеживать события конверсий непосредственно из Google Tag Manager.
...
1. [Добавить скрипт Revroute Analytics в GTM](#step-1-add-dub-analytics-script-to-gtm)
...
<Warning>
  ...
  аналитики](https://app.revroute.ru/settings/analytics))
</Warning>
...
![GTM Revroute ID Cookie Variable](/images/conversions/google-tag-manager/gtm-dub-id-cookie-variable.png)

Настройте переменную со следующими параметрами:

- **Variable Type**: выберите **1st Party Cookie**
- **Cookie Name**: введите `dub_id`
- **Variable Name**: назовите "Revroute ID Cookie"
...
2. **Использование вкладки Network** для проверки отправки запросов на эндпоинт аналитики Revroute
3. **Просмотр дашборда Revroute** для подтверждения, что события продаж отображаются в аналитике
