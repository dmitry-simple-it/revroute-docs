...
const pricingFaq = [
  ...
  },
  {
    ...
    a: 'Да, вы можете отменить подписку и отключить автоплатёж в любой момент в личном кабинете — доступ сохраняется до конца оплаченного периода. Периодичность и размер списаний, порядок отмены и возврата описаны в Соглашении о рекуррентных платежах на странице revroute.ru/ru/legal/recurring-payments.',
  },
  {
