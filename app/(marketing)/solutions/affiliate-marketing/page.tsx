...
const faqItems = [
  ...
  },
  {
    ...
    a: 'Нативные коннекторы с YooKassa (для биллинга), amoCRM, Bitrix24 (для CRM-сделок). Открытый REST API и webhook-события для интеграций с собственной инфраструктурой.',
  },
]
