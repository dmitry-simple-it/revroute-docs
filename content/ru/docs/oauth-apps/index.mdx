...
| Access token | 2 часа | `rr_access_token_...` — заголовок `Bearer` |
...
- `client_id` — публичный, с префиксом `rr_app_...`
- `client_secret` — показывается один раз при создании (только для private), с префиксом `rr_app_secret_...`
