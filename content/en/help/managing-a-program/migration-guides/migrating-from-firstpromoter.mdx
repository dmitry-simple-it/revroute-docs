...
Once you've [set up your Dub partner program](/help/managing-a-program/getting-started/setting-up-your-program), go to your [Partners tab](https://app.dub.co/program/partners), click on the `⋮` button and select "Import from FirstPromoter".
...
Each of your [campaigns](https://help.firstpromoter.com/en/articles/8971305-what-are-campaigns) on FirstPromoter will be mapped to a [partner group](/help/managing-a-program/getting-started/partner-groups) on Dub.
...
rewards](/help/managing-a-program/rewards-and-commissions/partner-rewards) work on Dub.
