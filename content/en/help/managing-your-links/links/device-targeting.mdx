---
title: "How to use device targeting on RevRoute?"
description: "Learn how to use device targeting on RevRoute to personalize the destination URL for your links based on the user's device type."
sidebarTitle: "Device targeting"
---

# How to use device targeting on RevRoute?
...
For example, you can set a custom destination URL for iOS devices by toggling the "iOS Targeting" switch in the [link builder](/help/managing-your-links/additional-guides/link-builder), and a different URL for Android devices by toggling the "Android Targeting" switch in the link builder.
...
![Use device targeting to personalize your link](https://s3.revroute.ru/dub-public/assets/help/device-targeting.png)
