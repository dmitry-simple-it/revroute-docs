...
const STATIC_PRIORITY: Record<string, number> = {
  ...
  '/anti-fraud': 0.85,
  // /tools/qr поднят с 0.75: теперь это посадочная Директа с органическим
  // потенциалом (~78 тыс. показов/мес по семантике QR, бриф
  // 30-gtm/paid/links/lp-qr-brief.md) — приоритет как у сокращателя.
  '/tools/qr': 0.85,
  // Посадочная «красивая ссылка» — узкий интент, ниже.
  '/tools/krasivaya-ssylka': 0.75,
  '/tools/utm': 0.75,
