...
<Tip>
  If you're using [Dub Partners](https://revroute.ru/), you can skip this
...
1. Navigate to your [workspace's Tracking settings page](https://app.revroute.ru/settings/tracking).
...
<Tip>
  ...
  <Accordion title="Option 3: Via the API">
    ...
    ```python Python
    link = d.links.create(url="https://revroute.ru", track_conversion=True)
    ```
