...
1. Настройте [домен диплинков](/docs/concepts/deep-links/quickstart#шаг-1-настройте-домены-диплинков-в-revroute) в RevRoute. Это заменяет домен Firebase `*.page.link` на ваш собственный брендированный домен диплинков.
2. [Создайте ваши диплинки](/docs/concepts/deep-links/quickstart#шаг-2-создайте-диплинки-в-revroute) в RevRoute.
3. [Обработайте перенаправления диплинков в вашем приложении](/docs/concepts/deep-links/quickstart#шаг-3-обработка-переходов-по-диплинкам-в-приложении) (подробности ниже).
