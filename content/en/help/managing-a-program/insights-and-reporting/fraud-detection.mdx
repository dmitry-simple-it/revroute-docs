...
Revroute's Fraud Detection helps you catch and take action on any fraudulent activity in your program. We give you the details for each event so you can make the best decision for your program and customers.

![Fraud table view](https://s3.revroute.ru/dub-public/assets/cms/fraud-table.png)
...
| Event | Description |
| --- | ----- |
| Cross-program ban  | This partner has been banned from one or more other Revroute programs, indicating a potential high-risk history. To protect security and privacy, specific details such as links, evidence, or notes are not shared across programs. |
...
![Fraud review](https://s3.revroute.ru/dub-public/assets/cms/fraud-review.png)
...
![Event partner](https://s3.revroute.ru/dub-public/assets/cms/fraud-event-partner.png)
...
![Event type](https://s3.revroute.ru/dub-public/assets/cms/fraud-event-type.png)
...
![Event commissions](https://s3.revroute.ru/dub-public/assets/cms/fraud-event-commissions.png)
...
2. Reviewing your internal sales information for any fraud signals (e.g. anti-fraud reports from your billing provider).
3. Reaching out to the partner in question via our [built-in messaging center](/help/managing-a-program/engaging-partners/messaging-partners) to get clarification on their referral activity.

![Resolving events](https://s3.revroute.ru/dub-public/assets/cms/fraud-resolving-event.png)
...
![Resolving](https://s3.revroute.ru/dub-public/assets/cms/fraud-review-resolve.png)
...
![Ban partner](https://s3.revroute.ru/dub-public/assets/cms/fraud-review-ban-01.png)
A reason must also be selected from the following options:

| Reason                              | Definition                                                                                      |
| ----------------------------------- | ----------------------------------------------------------------------------------------------- |
| Terms of Service Violation          | Partner violated your program rules or Revroute’s terms of service.                                  |
...
![Resolved events](https://s3.revroute.ru/dub-public/assets/cms/fraud-resolved-events.png)
...
![Fraud settings](/images/partners-overview/fraud-settings.png)
...
![Google campaign whitelist](/images/partners-overview/fraud-settings-google-whitelist.png)
...
![Referral settings](https://s3.revroute.ru/dub-public/assets/cms/fraud-settings-referral.png)
...
![Setting confirmation](https://s3.revroute.ru/dub-public/assets/cms/fraud-confirm-setting-change.png)
