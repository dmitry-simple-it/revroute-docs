...
![Partner Groups](https://s3.revroute.ru/dub-public/assets/cms/partner-groups.jpg)
...
![Group navigation](https://s3.revroute.ru/dub-public/assets/cms/group-navigation-1.png)
...
![Default group](https://s3.revroute.ru/dub-public/assets/cms/group-default.png)
...
![Create group](https://s3.revroute.ru/dub-public/assets/cms/group-create.png)
...
| Group ID    | This non-editable item is used for embedding the Revroute white-labeled referral dashboard within your app. [Learn more](/docs/partners/embedded-referrals).                                                                                                                                                      |
...
![Group rewards](https://s3.revroute.ru/dub-public/assets/cms/group-rewards-1.png)
...
![Group discounts](https://s3.revroute.ru/dub-public/assets/cms/group-discounts.png)
...
![Group settings](https://s3.revroute.ru/dub-public/assets/cms/group-settings-page.png)
...
Specify how long your commissions will be held in "pending" status before becoming eligible for payout. [Learn more.](/help/managing-a-program/sending-payouts/partner-payouts#payout-holding-period)
...
![Example group move settings](https://s3.revroute.ru/dub-public/assets/cms/move-group.png)
...
![Applications table](https://s3.revroute.ru/dub-public/assets/cms/group-applications-table.png)
...
![Select group](https://s3.revroute.ru/dub-public/assets/cms/group-application-selectgroup.png)
...
![All partners](https://s3.revroute.ru/dub-public/assets/cms/group-all-partners.png)
...
You can move a partner to a new group from their [partner profile page](/help/managing-a-program/getting-started/managing-program-partners#partner-details):

![Partner profile page group](/images/partners-overview/partner-profile-page-group.png)

Anytime you're changing a partner's group, you can enable **keep partner in selected group** to ignore any group move rules. This setting is also available from the partners [advanced settings](/help/managing-a-program/getting-started/managing-program-partners#partner-details).

![Partner move modal](/images/partners-overview/move-single-modal.png)

**Via the partner table**

As mentioned above, you can also use the multi-select function in the [partners table](http://app.revroute.ru/program/partners) to move one or many partners at a time to any group.
...
![Group move rules example](https://s3.revroute.ru/dub-public/assets/cms/move-group.png)

Partners that have [ignore group move rules](/help/managing-a-program/getting-started/managing-program-partners#ignore-group-move-rules) enabled will stay within their current group and not be affected by any move rules.
...
![Group move email](/images/partners-overview/partner-group-change-email.png)
...
![Partner profile page group history](/images/partners-overview/group-move-logs.png)
