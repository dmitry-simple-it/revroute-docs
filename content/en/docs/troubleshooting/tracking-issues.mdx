...
1. **Was the `rr_id` cookie present?** The lead event needs a `clickId` or a customer with a prior click. Open DevTools → Application → Cookies and confirm `rr_id` is set.
