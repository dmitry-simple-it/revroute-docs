...
og:title: "How to build your own Revroute integration"
...
You can build your own integrations with Revroute using our [API](/docs/api-reference/introduction).
...
<Steps>
  ...
  <Step title="Make an API request with the access token">
    ...
    You can initialize [Revroute SDK](/docs/sdks/overview) with the access token.

    Here is an example of how you can create a link using the [Revroute TypeScript SDK](/docs/sdks/typescript):
