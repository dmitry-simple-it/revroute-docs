...
description: "Learn about how you can use Dub Analytics to better understand your audience."
...
Dub also offers a [Real-time Events Stream](/help/managing-your-links/analytics/real-time-events-stream) view that shows you the events that are happening in real-time. These events are sorted by the time they occurred, so you can see the most recent events first.

![The Events Stream dashboard on Dub](https://assets.dub.co/cms/events-stream-dashboard-01.png)
