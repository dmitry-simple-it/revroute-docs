...
On Revroute, you can also create a branded landing page with details about your [partner program](/help/managing-a-program/partners-overview):
...
<ImageLink
  ...
  src="https://s3.revroute.ru/dub-public/assets/cms/program-application-form.png"
  href="https://partners.revroute.ru/dub"
  cta="View example ↗"
/>

<Tip>
  On Revroute, you can create a custom landing page for each [partner
...
![Branding page within your dashboard](https://s3.revroute.ru/dub-public/assets/cms/program-branding-tab2.png)
...
![Brand page within your dashboard](https://s3.revroute.ru/dub-public/assets/cms/lander-edit1.jpg)
...
![Brand page within your dashboard](https://s3.revroute.ru/dub-public/assets/cms/lander-insertblock1.jpg)

### Text

Best used for text and paragraph content. This section also uses markdown formatting when editing.

![Adding text content](https://s3.revroute.ru/dub-public/assets/cms/lander-insert-text.jpg)

### Image

For adding product screenshots and other complementary visuals to the program.

![Adding image content](https://s3.revroute.ru/dub-public/assets/cms/lander-insert-image.jpg)

### Files

For adding product screenshots and other complementary visuals to the program.

![Adding files](https://s3.revroute.ru/dub-public/assets/cms/lander-insert-file.jpg)
...
![Adding accordion content](https://s3.revroute.ru/dub-public/assets/cms/lander-insert-accordion.jpg)

### Earnings calculator

Give your partners a sense of how much they can earn, based on your default rewards.

![Adding earnings calculator](https://s3.revroute.ru/dub-public/assets/cms/lander-insert-calculator.jpg)
...
![Generate lander AI button](https://s3.revroute.ru/dub-public/assets/cms/generate-lander-ai-button.png)

Here's a quick demo of how it looks:

<video src="https://s3.revroute.ru/dub-public/assets/cms/generate-lander-ai-demo.mp4"
    loop
    autoPlay
    muted
    playsInline
...
![Publish button](https://s3.revroute.ru/dub-public/assets/cms/lander-publish-2.png)
## Landing page examples
Get inspired and check out some of these great examples that companies have already created:
<ImageCarousel
  images={[
    {
      src: "https://s3.revroute.ru/dub-public/assets/cms/lander-wisprflow-1.png",
      alt: "Wispr Flow Program Lander",
    },
    {
      src: "https://s3.revroute.ru/dub-public/assets/cms/lander-tella.png",
      alt: "Tella Program Lander",
    },
    {
      src: "https://s3.revroute.ru/dub-public/assets/cms/lander-superlist-1.png",
