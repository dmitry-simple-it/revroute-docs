...
description: "Learn more about why UTM parameters are important for marketing links and how to add them to your links using the Dub UTM Builder."
...
Dub also supports the ability to [create UTM templates](/help/managing-your-links/links/how-to-create-utm-templates) that you can reuse across your team, which leads to better campaign management & tracking accuracy.
