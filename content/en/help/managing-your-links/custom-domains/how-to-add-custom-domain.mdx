...
If you're on a paid plan on Dub ([Pro plan](https://dub.co/pricing) and above), you can claim a [complimentary .link custom domain](/help/managing-your-links/custom-domains/free-dot-link-domain) and use it as your short link domain – no DNS setup needed.

![Free .link domain](https://assets.dub.co/blog/free-dot-link.jpg)

Read our guide on [how to claim your free .link domain on Dub](/help/managing-your-links/custom-domains/free-dot-link-domain).
...
![The Add Domain modal in Dub](https://assets.dub.co/cms/add-domain-modal.png)
...
![Setting up DNS records for your domains on Dub](https://assets.dub.co/cms/configure-domain.png)
...
<Warning>
  ...
  Cloudflare domains with Dub](/help/managing-your-links/custom-domains/using-cloudflare-domains) for more
  information.
</Warning>
...
![Verifying domain ownership on Dub](https://assets.dub.co/cms/vercel-domain.png)
