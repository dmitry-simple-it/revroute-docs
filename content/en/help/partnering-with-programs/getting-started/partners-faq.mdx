...
For compliance reasons, you cannot change your account type once you've [received payouts on Revroute](/help/partnering-with-programs/receiving-payouts/receiving-payouts). If you still need to change your country, please [reach out to support](https://revroute.ru/contact/support).
...
Your commission is pending because there is a [30-day holding period](/help/partnering-with-programs/receiving-payouts/commissions-payouts#what-does-holding-period-mean). After 30 days, your commission will be confirmed and eligible for payout.
...
If you want, you can still [withdraw it for a `$0.50` fee](/help/partnering-with-programs/receiving-payouts/receiving-payouts#what-is-the-minimum-withdrawal-amount-and-how-does-it-work). Payouts above $10 are automatically deposited to your bank account at no additional cost.
...
You don't need an invite. Revroute uses [Stripe Express](https://support.stripe.com/express) to process payouts, which is different from the standard Stripe account. If your country is supported by Stripe Express, you will be able to see "Connect bank account" under the [Payouts](https://partners.revroute.ru/settings/payouts) tab.
...
### Can I connect my company's Stripe account to Revroute?
