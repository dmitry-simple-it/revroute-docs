...
![Folders RBAC](/images/ru/links/folders-page.jpg)
...
In addition to workspace-level permissions, individual members can be assigned their own roles for a specific folder. This lets you set exactly which members can access the folder and what they can do with the links inside it.
...
If you only have read access to a folder, you can request edit access from the folder admin. The admin will be notified by email and can then grant edit/owner access to you to manage the folder and its links.
