...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: (
      <>
        Да, вы можете отменить подписку и отключить автоплатёж в любой момент в личном кабинете —
        доступ сохраняется до конца оплаченного периода. Периодичность и размер списаний, порядок
        отмены и возврата описаны в{' '}
        <a
          href="/ru/legal/recurring-payments"
          className="text-[var(--text)] font-medium underline underline-offset-2"
        >
          Соглашении о рекуррентных платежах
        </a>
        .
      </>
    ),
