...
- `web`: The entirety of Revroute's application ([app.revroute.ru](https://app.dub.co)) + our link redirect infrastructure.
...
All of the code for the web app is located in here: [`main`/apps/web/app/app.revroute.ru](https://github.com/dubinc/dub/tree/main/apps/web/app/app.dub.co). This is using the Next.js [route group pattern](https://nextjs.org/docs/app/building-your-application/routing/route-groups).
