...
Similar to the approval process, you can reject an application from the [applicant form](/help/managing-a-program/recruiting-partners/program-applications#applicant-form) or use [bulk selection](/help/managing-a-program/recruiting-partners/program-applications#bulk-approve) for more than one applicant at a time.
