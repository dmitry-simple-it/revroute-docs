...
![Program bounties](https://s3.revroute.ru/dub-public/assets/cms/program-bounties.jpg)

Bounties on [Revroute Partners](https://revroute.ru/) let you reward partners for achieving goals or creating content about your product. This guide walks you through creating bounties, setting requirements, and managing submissions.

To view and manage your bounties, go to your **Partner Program** menu and click on **Bounties** under the _Engagement_ section:

![Bounty navigation location](https://s3.revroute.ru/dub-public/assets/cms/bounty-navigation.png)
...
<Info>
  ...
  ![Bounty email notification](https://s3.revroute.ru/dub-public/assets/cms/bounty-email-notification.png)
</Info>
...
![Create performance bounty](/images/partners-overview/performance-bounty.png)
...
| Logic | The success criteria are based on: total leads, total conversions, total revenue, or total commissions. [Learn more](/help/managing-a-program/engaging-partners/program-bounties#performance-logic).               |
| Reward | The reward amount the partner will receive upon completing the bounty. |
| Groups | [Partner group](/help/managing-a-program/getting-started/partner-groups) eligibility. The same bounty can be applied to multiple [partner groups](/help/managing-a-program/getting-started/partner-groups) – or all groups in your program. |
...
![Performance bounty logic](https://s3.revroute.ru/dub-public/assets/cms/performance-logic-3.png)
...
![Create submission bounty](/images/partners-overview/submission-bounty.png)
...
| Reward | The reward amount the partner will receive upon completing the bounty. |
| Groups | Partner group eligibility. The same bounty can be applied to multiple [partner groups](/help/managing-a-program/getting-started/partner-groups) – or all groups in your program. |
...
![Submission window](/images/partners-overview/submission-window.png)
...
![Submission frequency](/images/partners-overview/submission-frequency.png)
...
![Submission requirements](/images/partners-overview/manual-submission.png)
...
![Submission default](/images/partners-overview/submission-default.png)
...
![Allowed domains](/images/partners-overview/allowed-domains.png)
...
![Create submission bounty](/images/partners-overview/custom-bounty.png)
...
![Social metric — empty state (no data)](/images/partners-overview/social-metric-empty.png)
...
![Social metric — populated state with platform and target metric selected](/images/partners-overview/social-metric.png)

#### Add a variable bonus

You can also optionally reward for additional performance beyond the base criteria.

![Social metric — variable bonus configuration](/images/partners-overview/social-metric-variable.png)
...
![Bounty review table](https://s3.revroute.ru/dub-public/assets/cms/bounty-table-01.png)
...
![Bounty review examples](/images/partners-overview/bounty-review-examples.png)

From this view, you can either [approve](#approving-submissions) or [reject](#rejecting-submissions) the submission.

### Approving submissions

Once you approve a bounty submission, a [commission](/help/managing-a-program/rewards-and-commissions/partner-commissions) will be automatically created and due at your next payout. The partner will also receive a notification email:

![Bounty approved email](https://s3.revroute.ru/dub-public/assets/cms/bounty-approved-email.png)
<Info>
...
![Bounty rejected modal](/images/partners-overview/reject-bounty-modal.png)
...
![Bounty rejected email](/images/partners-overview/reject-bounty-email.png)
