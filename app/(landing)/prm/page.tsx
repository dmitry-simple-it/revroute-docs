...
export const metadata: Metadata = {
  ...
  description:
    'RevRoute — PRM-платформа для B2B: запускайте партнёрскую программу. Атрибуция до оплаты, расчёты с партнёрами под ключ, оплата за результат — без разработки и ручных таблиц.',
