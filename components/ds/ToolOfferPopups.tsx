 ...
 *     5 минут (lib/tools/offer-dismiss.ts) — попапы такому пользователю
...
const FEAR_BULLETS = [
  ...
  'В Free-тарифе — широкие возможности. Без навязывания.',
]
/** Короткая строка тех же страхов для попапов, где два первых буллета — продуктовые. */
const FEAR_LINE =
  'Аккаунт бесплатный: Free-тариф — навсегда, а банковская карта для регистрации не нужна.'

const COPY: Record<string, Record<Kind, PopupCopy>> = {
  qr: {
    popup_complete: {
      caption: 'Файл у вас',
      title: 'Код готов. Один момент про QR',
      bullets: [
        'Этот код — ваш навсегда: он статический и бесплатный.',
        'Но адрес внутри уже не поменять. В Free-аккаунте QR становится изменяемым, и по нему можно смотреть аналитику.',
        FEAR_LINE,
      ],
    ...
    exit_engaged: {
      ...
      bullets: [
        ...
        'В аккаунте код становится изменяемым: адрес можно поменять после печати, статистика переходов видна.',
        FEAR_LINE,
      ],
    ...
    exit_cold: {
      ...
      cta: 'Попробовать бесплатно',
      secondary: 'Сначала сделаю QR',
    },
  },
  shortener: {
    popup_complete: {
      caption: 'Ссылка в буфере',
      title: 'Готово. Но вы не узнаете статистику',
      bullets: [
        'Ссылка рабочая и бесплатная навсегда — можно вставлять куда угодно.',
        'Сколько раз по ней перешли, откуда и с каких устройств — видно только в аккаунте. Там же можно подключить свой домен: go.вашбренд.ru.',
        FEAR_LINE,
      ],
    ...
    exit_engaged: {
      caption: 'Секунду…',
      title: 'Ссылка будет работать. Но вы не узнаете статистику',
      bullets: [
        'Короткая ссылка бесплатна навсегда — она уже ваша.',
        'В аккаунте она начнёт считать переходы, там же можно подключить свой домен: go.вашбренд.ru.',
        FEAR_LINE,
      ],
      cta: 'Попробовать бесплатно',
      secondary: 'Доделаю без аккаунта',
