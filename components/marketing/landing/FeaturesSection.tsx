        ...
        <div className="mx-auto max-w-[1200px] px-6">
          ...
          <AnimateOnScroll>
            ...
            >
              ...
              >
                {[
                  { value: '7.2K', label: 'Клики', delta: '+18.4%', color: 'var(--blue)', data: [...metricTrends.clicks] },
                  { value: '165', label: 'Лиды', delta: '+12.1%', color: 'var(--purple)', data: [...metricTrends.leads] },
                  { value: '506 ₽', label: 'Продажи', delta: '+42.3%', color: 'var(--green)', data: [...metricTrends.sales] },
                  { value: '6.8%', label: 'Конверсия', delta: '+2.1 pp', color: 'var(--orange)', data: [...metricTrends.conversion] },
                ].map((stat) => (
