...
| Access token | 2 hours | `rr_access_token_...` — `Bearer` header |
...
- `client_id` — public, prefixed `rr_app_...`
- `client_secret` — only shown once at creation (private apps only), prefixed `rr_app_secret_...`
