...
import { breadcrumbs, faqPage } from '@/lib/seo/schemas'
...
export const metadata: Metadata = {
  title: 'Партнёрам — зарабатывайте на рекомендациях B2B',
  description:
    'Рекомендуйте B2B-сервисы и зарабатывайте до 50% комиссии с реальных оплат. Бесплатно для партнёра, атрибуция до оплаты, выплаты с чеками и актами.',
