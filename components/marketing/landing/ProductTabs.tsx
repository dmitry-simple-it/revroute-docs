...
const tabs = [
  ...
  },
  {
    ...
    // Страницы /analytics больше нет. Вкладка про путь «клик → покупка» по
    // ссылкам — это /links (там «Аналитика в реальном времени» и «Конверсии и
    // деньги»); аналитика партнёрской программы отдельно живёт на /prm.
    linkHref: '/links',
    linkText: 'Подробнее про аналитику ссылок',
  },
  {
    id: 'partners',
