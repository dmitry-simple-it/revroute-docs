...
![Program applications location](https://assets.dub.co/cms/applications-nav-1.png)
...
![Application details](https://assets.dub.co/cms/applications-profile-view-1.png)
...
![Verified account badge](https://assets.dub.co/cms/verified-accounts-1.png)
...
![Application risk flag](https://assets.dub.co/cms/application-flag-review.png)
...
![Approve button](https://assets.dub.co/cms/applications-approve-button-1.png)
...
![Select all](https://assets.dub.co/cms/applications-select-all-2.png)
...
![Group settings](https://assets.dub.co/cms/group-additional-settings.png)
...
![Group settings](https://assets.dub.co/cms/confirm-auto-approve.png)
...
![Reject applicant](https://assets.dub.co/cms/application-reject-modal.png)
...
![Application dropdown](https://assets.dub.co/cms/application-dropdown-01.png)

From the rejected partners table, find the application you’d like to revisit and click the row to open it.

![Application dropdown](https://assets.dub.co/cms/rejected-partners-table-01.png)

Once inside the application, click **Approve**. The partner will immediately be enrolled in your program.

![Application dropdown](https://assets.dub.co/cms/rejected-partners-application-01.png)
##
