...
![A/B test location](https://assets.dub.co/cms/ab-location.png)
...
![A/B test builder](https://assets.dub.co/cms/ab-dialog.png)

### Testing URLs

You can enter a maximum of 4 additional testing URLs that you'd like to send your traffic to.

![Testing URLs](https://assets.dub.co/cms/ab-urls.png)
...
![Traffic split](https://assets.dub.co/cms/ab-trafficsplit.png)
...
![Completion date](https://assets.dub.co/cms/ab-completion-date.png)
...
![Links view](https://assets.dub.co/cms/ab-link-icon-2.png)
...
![Links view expanded](https://assets.dub.co/cms/ab-link-expand-2.png)
...
![End test early](https://assets.dub.co/cms/ab-complete-2.png)

From here, you'll select the new destination URL for your short link.

![Select the destination URL](https://assets.dub.co/cms/ab-end-test-2.png)
