...
Revroute allows you to perform bulk operations on links. This is particularly useful when you need to create, update, or delete multiple links at once without having to make multiple API requests.
...
<Warning>
  ...
  previews. Also, [webhook
  events](/docs/webhooks) will not be triggered when using bulk
  link creation.
</Warning>
...
<Warning>
  ...
  [webhook events](/docs/webhooks) will not be triggered when using
  bulk link updates
</Warning>
