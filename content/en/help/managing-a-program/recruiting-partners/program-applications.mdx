...
![Program applications location](https://s3.revroute.ru/dub-public/assets/cms/applications-nav-1.png)
...
![Applications table](/images/partners-overview/applicant-table.png)
...
![Application settings button](/images/partners-overview/application-settings.png)
...
![Application settings criteria](/images/partners-overview/application-settings-criteria.png)
...
If your program is listed in the [Revroute program marketplace](https://revroute.ru/help/partnering-with-programs/joining-programs/program-marketplace), click the **Marketplace** toggle to access the marketplace settings. Here you can set the description that's shown to partners, and categories to help find your program more easily.

![Marketplace settings](/images/partners-overview/applications-settings-marketplace.png)
...
![Application details](https://s3.revroute.ru/dub-public/assets/cms/applications-profile-view-1.png)
...
![Verified account badge](https://s3.revroute.ru/dub-public/assets/cms/verified-accounts-1.png)
...
These signals are powered by our [Fraud Detection feature](/help/managing-a-program/insights-and-reporting/fraud-detection) and are meant to protect your partner program from risk and potential fraud.

![Application risk flag](https://s3.revroute.ru/dub-public/assets/cms/application-flag-review.png)
...
| Cross-program ban | This partner has been banned from one or more other Revroute programs, indicating a potential high-risk history. |
...
<Info>
  Learn more about how [Fraud Detection](/help/managing-a-program/insights-and-reporting/fraud-detection) works on
  Revroute.
</Info>
...
![Approve button](https://s3.revroute.ru/dub-public/assets/cms/applications-approve-button-1.png)
...
![Select all](https://s3.revroute.ru/dub-public/assets/cms/applications-select-all-2.png)
Once selected, click **Approve** to add them to your program instantly.

### Auto-approve

To auto-approve any new pending applications for your program, go to your [individual groups](/help/managing-a-program/getting-started/partner-groups) and click on the **Settings** tab. Here you'll find the auto-approve toggle in the "Additional settings" group.

![Group settings](https://s3.revroute.ru/dub-public/assets/cms/group-additional-settings.png)
...
![Group settings](https://s3.revroute.ru/dub-public/assets/cms/confirm-auto-approve.png)
...
Similar to the approval process, you can reject an application from the [applicant form](/help/managing-a-program/recruiting-partners/program-applications#via-the-application-form) or use [bulk selection](/help/managing-a-program/recruiting-partners/program-applications#bulk-approve) for more than one applicant at a time.

When an applicant is rejected, they cannot reapply to the program and will see the status reflected in their dashboard.

If you suspect this partner application shows signs of fraud, check the confirmation box when rejecting the applicant. This will flag the applicant in other programs to help keep the Revroute network safe.

![Reject applicant](https://s3.revroute.ru/dub-public/assets/cms/application-reject-modal.png)
...
![Application dropdown](https://s3.revroute.ru/dub-public/assets/cms/application-dropdown-01.png)

From the rejected partners table, find the application you’d like to revisit and click the row to open it.

![Application dropdown](https://s3.revroute.ru/dub-public/assets/cms/rejected-partners-table-01.png)

Once inside the application, click **Approve**. The partner will immediately be enrolled in your program.

![Application dropdown](https://s3.revroute.ru/dub-public/assets/cms/rejected-partners-application-01.png)
##
