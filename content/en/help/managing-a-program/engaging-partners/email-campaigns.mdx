...
When a partner replies to any email you send through Dub, their message is always delivered to the support email address you set when creating your program. You can also view or update that address in your [resources page](/help/managing-a-program/getting-started/program-resources).
