...
![A/B test location](https://s3.revroute.ru/dub-public/assets/cms/ab-location.png)
...
![A/B test builder](https://s3.revroute.ru/dub-public/assets/cms/ab-dialog.png)

### Testing URLs

You can enter a maximum of 4 additional testing URLs that you'd like to send your traffic to.

![Testing URLs](https://s3.revroute.ru/dub-public/assets/cms/ab-urls.png)
...
![Traffic split](https://s3.revroute.ru/dub-public/assets/cms/ab-trafficsplit.png)
...
![Completion date](https://s3.revroute.ru/dub-public/assets/cms/ab-completion-date.png)
...
![Links view](https://s3.revroute.ru/dub-public/assets/cms/ab-link-icon-2.png)
...
![Links view expanded](https://s3.revroute.ru/dub-public/assets/cms/ab-link-expand-2.png)
...
![End test early](https://s3.revroute.ru/dub-public/assets/cms/ab-complete-2.png)

From here, you'll select the new destination URL for your short link.

![Select the destination URL](https://s3.revroute.ru/dub-public/assets/cms/ab-end-test-2.png)
