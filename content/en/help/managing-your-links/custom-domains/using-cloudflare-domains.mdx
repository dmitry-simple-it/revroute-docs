...
We recommend using Cloudflare's DNS only mode for your custom domain. This makes sure that requests/clicks to your short links will always reach Dub directly instead of being served through Cloudflare – which can lead to [inaccurate analytics data](/help/managing-your-links/analytics/incorrect-analytics-geolocation-data).
...
To set this up, all you need to do is [set your domain's DNS records](/help/managing-your-links/custom-domains/how-to-add-custom-domain#step-2-configure-your-domain) to point to Dub's servers and make sure that you're using the **DNS only** option on Cloudflare.
