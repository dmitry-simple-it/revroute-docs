...
2. **Length**: Shorter domains are easier to remember and type. To achieve this, some companies might opt for acronyms or abbreviations. For example, one of our customers Tinybird uses `tbrd.co` for their short domain.
...
<Tip>
  If you're on a [Pro plan](https://revroute.ru/pricing) or higher, you can also claim a [complimentary .link custom domain](/help/managing-your-links/custom-domains/free-dot-link-domain) and use it as your short link domain.
