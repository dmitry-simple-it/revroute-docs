...
To set up your email domain, go to the "Email domains" tab in your workspace domain settings: [app.revroute.ru/settings/domains/email](https://app.revroute.ru/settings/domains/email)

![Email domains](https://s3.revroute.ru/dub-public/assets/cms/email-no-domain.png)

Click **Add domain**, and enter the domain you want to send emails from.

![Add domain modal](https://s3.revroute.ru/dub-public/assets/cms/email-domain-modal.png)
...
![DNS records](https://s3.revroute.ru/dub-public/assets/cms/email-domain-records-3.png)
...
![Active email domain](https://s3.revroute.ru/dub-public/assets/cms/email-domain-active-2.png)
...
![Email location](https://s3.revroute.ru/dub-public/assets/cms/email-nav-location.png)

## Creating a new campaign

Click **Create Campaign** in the top-right corner, then select the type of email you want to send.

![Create campaign](https://s3.revroute.ru/dub-public/assets/cms/email-create-campaign.png)
...
![Marketing fields](https://s3.revroute.ru/dub-public/assets/cms/email-content-marketing.png)
...
![Transactional fields](https://s3.revroute.ru/dub-public/assets/cms/email-content-transactional.png)
...
![Email styles](https://s3.revroute.ru/dub-public/assets/cms/email-styles.png)
...
| Bold              | `**Bold text**`                              |
| Italic            | `*italic text*`                              |
| Inline Hyperlinks | `[Revroute](https://revroute.ru)`                      |
...
![Preview email](https://s3.revroute.ru/dub-public/assets/cms/email-preview-modal.png)
...
![Email metrics](https://s3.revroute.ru/dub-public/assets/cms/email-metrics.png)
