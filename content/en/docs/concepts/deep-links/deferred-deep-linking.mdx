...
![Deferred deep linking on Dub](/images/deferred-deep-linking.png)
...
2. Dub redirects the user to the App Store or Play Store by using [device targeting](/help/managing-your-links/links/device-targeting)
