...
![The workspace creation modal on Dub](https://assets.dub.co/help/workspace-creation-modal.png)
...
![Onboarding checklist for a new workspace in Dub](https://assets.dub.co/help/onboarding-checklist.png)
...
Dub is the only link management platform that allows you to [add custom domains](/help/managing-your-links/custom-domains/how-to-add-custom-domain) for free. The number of domains that you can add to a workspace depends on your plan:
...
![Filtering links by domain in Dub](https://assets.dub.co/help/filter-links-by-domain.png)
