...
On any given day, Revroute tracks upwards of **5 million clicks, [conversion](/help/article/dub-conversions), and [commission](/help/managing-a-program/rewards-and-commissions/partner-commissions) events.**
...
![Program analytics location](https://s3.revroute.ru/dub-public/assets/cms/program-analytics-location.png)
...
![Time-series chart](https://s3.revroute.ru/dub-public/assets/cms/program-analytics-timechart-1.png)

**Data toggle**

You can change the data displayed by clicking the `123 | $` toggle in the top right of the data type section.

By default `$` is selected, as it related directly to your [reward types](/help/managing-a-program/rewards-and-commissions/partner-rewards). Switching to `123` will change any monetary values to their specific reward count. If your program has other monetary rewards (clicks, leads, sales), their dollar amount will show as well.
...
![Partner data table](https://s3.revroute.ru/dub-public/assets/cms/program-analytics-partnertable-revenue.png)
...
![Filtering your program analytics](https://s3.revroute.ru/dub-public/assets/cms/program-analytics-filter.png)
