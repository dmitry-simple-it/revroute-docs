...
export const integrations: Integration[] = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: 'Настройка',
        text: '1. Установите приложение в Cal.com. 2. Подключите клиентский скрипт RevRoute и добавьте cal.com в outbound-домены. 3. Бронирования автоматически отслеживаются.',
      },
      {
