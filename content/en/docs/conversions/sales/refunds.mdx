...
description: Learn how to track refund events for your Revroute partner program
---
...
If you're using [Revroute Partners](https://dub.co/partners) for your affiliate program, you might also want to track refund events and update the associated [partner commission's status](/help/managing-a-program/rewards-and-commissions/partner-commissions#commission-statuses) accordingly.

<Note>
  Commissions that are already paid cannot be refunded. To account for this, we
  recommend setting a [payout holding
  period](/help/managing-a-program/sending-payouts/partner-payouts#payout-holding-period) for your program
...
If you still need to refund a commission that has already been paid, you can [create a clawback](/help/managing-a-program/rewards-and-commissions/partner-commissions#creating-a-clawback) instead.
