...
const utmFeatures = [
  {
    ...
    desc: 'Договоритесь о стандарте UTM один раз — все ссылки команды создаются по заданным шаблонам.',
  },
  {
    title: 'Подсказки',
  ...
  return (
    <>
      <PageHero
        ...
        desc="Платформа управления ссылками для маркетинговых команд, основателей и авторов. Помогает понять, какие каналы реально приводят клиентов и деньги."
        actions={
          <>
        ...
        <div className="mx-auto max-w-[1200px] px-6">
          <div className="mb-10">
            ...
            <SectionDesc className="mt-6">
              Настройте домен, slug, превью, UTM и QR — всё в одном конструкторе. Создавайте
              брендированные ссылки, на которые хочется нажать.
            </SectionDesc>
          </div>
