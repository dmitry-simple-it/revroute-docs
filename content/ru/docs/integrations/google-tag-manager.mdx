...
[Интеграция Revroute с Google Tag Manager](https://dub.co/integrations/google-tag-manager) позволяет отслеживать события конверсий непосредственно из Google Tag Manager.
