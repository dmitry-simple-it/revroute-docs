...
![Deep links on Revroute](https://assets.dub.co/cms/deep-links.jpg)
...
Сначала необходимо добавить пользовательский домен в ваше рабочее пространство Revroute. Перейдите в [настройки доменов рабочего пространства](https://app.dub.co/settings/domains) и нажмите **Add Domain**.
...
Для этого перейдите в [настройки доменов рабочего пространства](https://app.dub.co/settings/domains) и нажмите кнопку редактирования для вашего пользовательского домена:

![Deep link configuration files](https://assets.dub.co/cms/update-domain-button.png)

In the domain modal, click on **Show advanced settings**, which will open up the Deep Link Configuration settings fields.

![Deep link configuration settings](https://assets.dub.co/cms/domain-modal-advanced-settings.png)
...
Go to your [Revroute dashboard](https://app.dub.co) and click **Create Link** in the top navigation bar.
...
![Deep link builder](https://assets.dub.co/help/dub-link-builder.jpg)
...
![Deep link device targeting configuration](https://assets.dub.co/help/device-targeting.png)
