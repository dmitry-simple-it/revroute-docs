...
![Inspect a Dub link](https://assets.dub.co/changelog/link-inspector.png)
...
![Reporting a malicious link on Dub](https://assets.dub.co/help/report-link.png)

This will open up a form where you can provide more information about the malicious link.

![Reporting a malicious link on Dub](https://assets.dub.co/help/report-link-form.png)
