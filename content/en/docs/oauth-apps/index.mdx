...
If you're building a script that only talks to your own workspace, use a [personal API key](/docs/api-reference/authentication) — OAuth is overkill.
...
<CardGroup cols={2}>
  ...
  <Card title="API errors" href="/docs/api-reference/errors">
