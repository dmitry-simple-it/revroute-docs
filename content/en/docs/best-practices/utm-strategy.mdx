...
3. **In a separate script tag** (e.g. via the RevRoute client script's built-in UTM tracking). Best for client-side tools that need to read UTMs before the redirect.
