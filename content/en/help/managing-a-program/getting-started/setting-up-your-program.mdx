...
description: "Step-by-step guide to go from zero to a live partner program on RevRoute."
---
...
In this guide, we will walk you through step-by-step how to set up your partner program on [RevRoute Partners](https://revroute.ru/) and start growing your affiliate revenue.
...
<Note>
  ...
  guides](/help/managing-a-program/migration-guides/migrating-from-rewardful) or [contact
  support](https://revroute.ru/contact/support).
</Note>

## Step 1: Getting started

**Goal**: Set up your program name, logo, and [referral link settings](/help/managing-a-program/getting-started/partner-link-settings).
...
3. **Referral link**: Set the domain and destination for partner links:
   - **Program domain**: connect a domain you own (DNS setup required). Use a domain dedicated to your program (e.g., `refer.yourcompany.com`).
   - **Website URL**: Where visitors go when they click a partner's referral link (e.g., `https://yourcompany.com`).

![Create partner program wizard, Getting started step: company name, logo, program domain and website URL](/images/ru/program/setup/wizard-step-1-start.jpg)
...
2. **Commission structure (only for sale rewards)**
   ...
   - **One-off**: Fixed payout per conversion (e.g., 2,000 ₽ per sale)

3. **Duration (only for recurring rewards)**: How long partners earn (e.g., 12 months)

4. **Reward amount**:
   - **Percentage**: Share of revenue (e.g., 15% per sale)
   - **Flat**: Fixed amount per conversion (e.g., 2,000 ₽ per lead)

![Configure rewards step: Sale reward type, recurring commission for 12 months, percentage of revenue](/images/ru/program/setup/wizard-step-2-rewards.jpg)

Select your reward conditions and click **Continue**.

<Tip>
  You can add more [reward conditions](/help/managing-a-program/rewards-and-commissions/partner-rewards) and
  [partner groups](/help/managing-a-program/getting-started/partner-groups) later in your program settings.
</Tip>
...
<Note>
  ...
  later](/help/managing-a-program/recruiting-partners/inviting-partners) from the Partners tab.
</Note>
...
![Invite partners step: partner email and the Add partner button](/images/ru/program/setup/wizard-step-3-partners.jpg)
...
These appear on the partner dashboard. You can add or update them later in your [program resources tab](/help/managing-a-program/getting-started/program-resources).

![Help and Support step: support email, help center URL and terms URL](/images/ru/program/setup/wizard-step-4-support.jpg)
...
- **Referral link type**: e.g. `refer.revroute.ru/{partner-link-key}`
- **Website URL**: Where partner links redirect

![Overview step: Reward, Referral link type and Website URL cards with the Create partner program button](/images/ru/program/setup/wizard-step-5-overview.jpg)
