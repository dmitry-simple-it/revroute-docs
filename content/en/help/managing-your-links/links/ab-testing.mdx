---
title: "How to run A/B tests with RevRoute Links?"
...
![A/B test location](/images/ru/links/link-builder.jpg)
...
![A/B test builder](/images/ru/links/ab-test-dialog.jpg)

### Testing URLs

You can enter a maximum of 4 additional testing URLs that you'd like to send your traffic to.

![Testing URLs](/images/ru/links/ab-test-urls.jpg)
...
Click and drag the dividers between each group to adjust the traffic to each destination URL. The minimum percentage you can set traffic to is 10%.

### Completion Date

By default, A/B tests will be set to run for 2 weeks, as that is enough time to collect performance data to make a decision.

You can run a test for a shorter period, but that's not recommended because in most cases, you won't collect enough data to make a decision. The longest you can run a test for is 6 weeks.

## Active A/B tests

While an A/B test is active, a flask icon is shown on each link. You can see this while viewing all your links.

![Links view](/images/ru/links/ab-test-flask-icon.jpg)

You can click this icon to expand the current link view to show all the destination URLs you've entered for testing. This will show you the traffic percentage you've set and the click, lead, and sale performance.

![Links view expanded](/images/ru/links/ab-test-link-expanded.jpg)
...
![End test early](/images/ru/links/ab-test-end-button.jpg)

From here, you'll select the new destination URL for your short link.

![Select the destination URL](/images/ru/links/ab-test-end-select-url.jpg)

After clicking **End test**, make sure to save your link changes in the next screen to confirm the changes.
