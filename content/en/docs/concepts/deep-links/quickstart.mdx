...
First, you'll need to add a custom domain to your Revroute workspace. Navigate to your [workspace domain settings](https://app.dub.co/settings/domains) and click **Add Domain**.
