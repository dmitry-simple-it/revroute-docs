...
Then, the [Revroute Analytics script](/docs/sdks/client-side/introduction) detects the `dub_id` parameter and stores it as a **first-party cookie**.
...
If your customer journey spans multiple domains, Revroute supports [cross-domain tracking](/docs/sdks/client-side/features/cross-domain-tracking) as well:
...
See the [`track/sale` API reference](/docs/api-reference/endpoint/track-sale) for the full list of fields accepted in direct sale tracking.
