...
<Steps>
  ...
  <Step title="Set up Revroute SDK">
    ...
    Create the Revroute client and send leads to Revroute using the `dub.track.lead()` function.
...
<Card
  title="Appwrite + Revroute Next.js  Example"
  icon="github"
  href="https://github.com/appwrite-community/appwrite-dub-next"
>
  See how to track new user sign-ups with Appwrite and the Revroute SDK.
</Card>
