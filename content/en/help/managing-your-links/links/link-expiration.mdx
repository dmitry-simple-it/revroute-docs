...
If you set an expiration date for your link, the user will see an "Expired Link" page when they try to access the link after the expiration date.

![Expired link page](/images/ru/links/expired-link-placeholder.jpg)
...
![Expired link page](/images/ru/links/link-expiration-url.jpg)
...
1. Go to the [Domains settings page](https://app.revroute.ru/settings/domains) in your RevRoute dashboard.
2. Click on the `⋮` button of domain that you want to set the default expiration URL for, which will open a dropdown menu.

![More options popover](/images/ru/links/domain-row-menu.jpg)
...
![Default expiration URL for a domain](/images/ru/links/domain-update-modal.jpg)
