---
title: "How to use geo targeting on RevRoute?"
description: "Learn how to use geo targeting on RevRoute to redirect your users to different links based on their location."
sidebarTitle: "Geo targeting"
---

# How to use geo targeting on RevRoute?
...
![Use Geo Targeting to redirect your users to different links based on their location](https://s3.revroute.ru/dub-public/assets/help/geo-targeting.png)
...
## Usage with the RevRoute API

You can also use the RevRoute API to create geo-targeted links.

To do this, you will need to set the `geo` field in the link creation request. The `geo` field should be an object with a [valid country code](#list-of-valid-country-codes) as the key and the respective URL as the value.
...
Here's a list of valid country codes that you can use with the RevRoute API:
