...
<ImageLink
  ...
  src="https://s3.revroute.ru/dub-public/assets/cms/program-application-form-1.png"
...
![Group selection](https://s3.revroute.ru/dub-public/assets/cms/program-group-click.png)

From the tab navigation, click **Branding,** then in the content panel, choose **Application form** to open the editor.

![Branding page within your dashboard](https://s3.revroute.ru/dub-public/assets/cms/program-branding-tab-1.png)
...
![Mandatory fields](https://s3.revroute.ru/dub-public/assets/cms/application-mandatory.png)
...
![Brand page within your dashboard](https://s3.revroute.ru/dub-public/assets/cms/application-edit1.png)

## Input field types

Click **Insert field** to open the selector, then pick the input type you want to add.

![Insert field](https://s3.revroute.ru/dub-public/assets/cms/application-insertfield2.png)

### Short text

Use for short answers like names, one-line bios, or URLs.

![Adding short text fields](https://s3.revroute.ru/dub-public/assets/cms/application-shorttext.png)
...
![Adding long text fields](https://s3.revroute.ru/dub-public/assets/cms/application-longtext.png)
...
![Adding files](https://s3.revroute.ru/dub-public/assets/cms/application-dropdown.png)
...
![Adding accordion content](https://s3.revroute.ru/dub-public/assets/cms/application-multiplechoice.png)
...
![Adding image upload](https://s3.revroute.ru/dub-public/assets/cms/application-imageupload.png)
...
![Adding website and social inputs](https://s3.revroute.ru/dub-public/assets/cms/application-website.png)
...
![Publish button](https://s3.revroute.ru/dub-public/assets/cms/application-publish.png)
##
