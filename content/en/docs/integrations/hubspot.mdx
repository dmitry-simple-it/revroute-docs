...
Revroute's [HubSpot integration](https://dub.co/integrations/hubspot) allows you to track conversion events directly from HubSpot.
...
Finally, install the [HubSpot Revroute Integration](https://app.dub.co/integrations/hubspot) to your workspace.
