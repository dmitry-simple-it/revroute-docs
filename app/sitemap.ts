...
const STATIC_PRIORITY: Record<string, number> = {
  ...
  '/solutions/saas': 0.8,
  // Посадочные под Директ (брифы 30-gtm/paid/links). У /qr есть и органический
  // потенциал (~78 тыс. показов/мес по семантике), поэтому приоритет как у
  // сокращателя; страница красивой ссылки — узкий интент, ниже.
  '/qr': 0.85,
  '/links/krasivaya-ssylka': 0.75,
