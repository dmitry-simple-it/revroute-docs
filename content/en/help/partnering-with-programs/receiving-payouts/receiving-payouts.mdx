...
Once you've set up a [partner profile on Revroute](https://partners.dub.co/), you can connect your bank account to start receiving payouts from the programs you're working with.
...
First, go to your [payout settings on Revroute](https://partners.dub.co/settings/payouts) and select "Connect bank account":
...
<Tip>
  ...
  - Reach out to [Revroute support](https://dub.co/contact/support)
</Tip>
