...
<CheckList>
  ...
  >
    ...
    Alternatively, you can also use our [default Dub-branded domains](/help/managing-your-links/custom-domains/default-dub-domains) instead.

  </CheckListItem>
</CheckList>

Dub's link builder comes with powerful features like [UTM builder](/help/managing-your-links/links/utm-builder), [device targeting](/help/managing-your-links/links/device-targeting), [password protection](/help/managing-your-links/links/password-protected-links), [expiration dates](/help/managing-your-links/links/link-expiration), and more.
...
<Steps>
  <Step title="Open the Dub link builder">
    ...
    There are 3 ways to open the [Dub link builder](/help/managing-your-links/additional-guides/dub-link-builder) to create a short link:
  ...
  <Step title="Add tags to your short link" optional>
    ...
    ![Fun fact: You can assign multiple tags to a given Dub link](https://assets.dub.co/help/multiple-tags-dropdown.png)
