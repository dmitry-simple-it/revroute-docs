...
![Commissions page within your dashboard](https://assets.dub.co/cms/commission-dashboard-1.png)

This opens up the commissions table view, where you can see a list of your historical commissions for your program:

![Commissions page within your dashboard](https://assets.dub.co/cms/commission-table.png)
...
- `Refunded`: If the sale for the commission was refunded. This is usually automatically detected via our [Stripe integration](https://revroute.ru/integrations/stripe), or can also be manually set via the dashboard or the [API](/docs/api-reference/endpoint/update-a-commission).
...
![Create one-time commission](https://assets.dub.co/cms/create-commission-main.png)

It can also be accomplished by clicking **Create commission** from an individual partner profile

![Create one-time commission](https://assets.dub.co/cms/create-commission-partner.png)
...
![Create one-time commission](https://assets.dub.co/cms/create-commission-onetime-01.png)
...
![Create one-time commission](https://assets.dub.co/cms/create-commission-lead-01.png)
...
![Create sale commission](https://assets.dub.co/cms/create-commission-sale-01.png)
...
![Create customer modal](https://assets.dub.co/cms/create-new-customer-01.png)
...
If you've already [connected to Stripe](/docs/integrations/stripe#stripe), you can import your customer by clicking on **Import from Stripe**. This will allow you to search existing Stripe customers by their email, and click to import their details into Revroute.

<Tip>
  If a customer with the same Stripe Customer ID already exists in Revroute, you
  won't be able to import that customer.
</Tip>

>

![Importing a Stripe customer](https://assets.dub.co/cms/import-customer-from-stripe-01.png)

Once selected, it will auto-fill the customer profile details. Click **Create customer** to add them to Revroute.

![Importing a Stripe customer](https://assets.dub.co/cms/import-customer-from-stripe-02.png)
...
![Importing invoices from Stripe](https://assets.dub.co/cms/import-invoices-from-stripe-01.png)
...
![Commissions dropdown](https://assets.dub.co/cms/commissions-dropdown.png)
...
![Clawback created](https://assets.dub.co/cms/clawback-created.png)

The partner affected will see this reflected in their earnings view on their dashboard:

![Clawback partner view](https://assets.dub.co/cms/clawback-partner-view.png)
