...
To do this, you need to whitelist your [Dub short domain](/help/managing-your-links/custom-domains/how-to-add-custom-domain) as an allowed origin on your site by adding the following response headers to your site:
