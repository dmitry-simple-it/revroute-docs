...
E.g. if you have marketing teams from different departments within your Revroute workspace, you can create folders for each team with role-based access controls to ensure members can only see the links that they should have access to.

![Folders RBAC](https://s3.revroute.ru/dub-public/assets/cms/folders-rbac.png)
...
In Revroute's link folders, RBAC lets you control who can access specific folders and what they can do with the links inside them. For example, marketing team members might only have access to the "Marketing Campaigns" folder, while team leads have full access to all folders.
...
<Tip>
  If you're on the [Pro plan](https://revroute.ru/pricing), you can only create
  folders with the default **"Can edit"** settings. Only [Business
  plan](https://revroute.ru/pricing) and above users can create folders with the
...
![Folders member option](https://s3.revroute.ru/dub-public/assets/cms/folders-action-member-option.png)

This will open up the member access control panel, where you can set different roles to different users:

![Folders member option](https://s3.revroute.ru/dub-public/assets/cms/folder-members-rbac.png)
...
<Tip>
  If you are using machine users for
...
![Request edit access folder](https://s3.revroute.ru/dub-public/assets/cms/request-edit-folder.png)
...
![Folder access request email](https://s3.revroute.ru/dub-public/assets/cms/folder-access-request-email.png)
