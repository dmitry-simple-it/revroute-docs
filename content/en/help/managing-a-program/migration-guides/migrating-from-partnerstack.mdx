...
In this article, we'll learn how to import your PartnerStack affiliate program to[ Dub Partners](/help/managing-a-program/dub-partners) for a more powerful, scalable, and branded partner management experience.
...
Once you've [set up your Dub partner program](/help/managing-a-program/getting-started/setting-up-your-program), go to your [Partners tab](https://app.dub.co/program/partners), click on the `⋮` button and select "Import from PartnerStack".
