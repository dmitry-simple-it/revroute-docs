...
og:title: "Migrating from Firebase Dynamic Links to Revroute"
og:image: "https://s3.revroute.ru/dub-public/assets/cms/dub-firebase.jpeg"
...
1. Configure your [deep link domain](/docs/concepts/deep-links/quickstart#step-1-configure-your-deep-link-domains-on-dub) on Revroute. This replaces Firebase's `*.page.link` domain with your own branded deep link domain.
2. [Create your deep links](/docs/concepts/deep-links/quickstart#step-2%3A-create-your-deep-links-on-dub) on Revroute.
