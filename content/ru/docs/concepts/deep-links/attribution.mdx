...
<Note>
  ...
  [свяжитесь с нами](https://dub.co/contact/support).
</Note>
...
Для этого перейдите на [страницу настроек отслеживания вашего рабочего пространства](https://app.dub.co/settings/tracking) и сгенерируйте новый публичный ключ в разделе **Publishable Key**.
...
После включения отслеживания конверсий для ваших ссылок все отслеженные конверсии будут отображаться в [панели аналитики](https://app.dub.co/analytics). Мы предоставляем 3 различных представления для анализа конверсий:
