...
Alternatively, you can also [use Dub with your custom domain](/help/managing-your-links/custom-domains/how-to-add-custom-domain), instead of the default `dub.sh` domain.
