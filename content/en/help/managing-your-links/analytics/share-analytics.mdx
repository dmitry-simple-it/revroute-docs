...
![More options dropdown menu on the links dashboard](https://assets.dub.co/help/hover-link-card-analytics.png)

**Option 2**: On the analytics page for a given short link, click on the **Share** button in the top right corner.

![Share button on the link](https://assets.dub.co/help/link-analytics-share-button.png)

Then, inside the **Share Dashboard** modal, toggle the **Enable public sharing** switch to **ON**.

![Share short link dashboard modal](https://assets.dub.co/cms/share-modal-link.png)
...
![Folder dropdown options](https://assets.dub.co/cms/share-folder-dropdown.png)

**Option 2**: On the analytics page for a given link folder, click on the **Share** button in the top right corner.

![Share button on the folder](https://assets.dub.co/cms/share-folder-analytics.png)

Then, inside the **Share Dashboard** modal, toggle the **Enable public sharing** switch to **ON**.

![Share folder dashboard modal](https://assets.dub.co/cms/share-modal-folder.png)
...
![Shared folder dashboard with conversion analytics](https://assets.dub.co/cms/shared-folder-conversion.png)

Here's how the dashboard looks without conversion analytics enabled:

![Shared folder dashboard with no conversion analytics](https://assets.dub.co/cms/shared-folder-no-conversion.png)
...
![Share Dashboard modal with password protection enabled](https://assets.dub.co/cms/share-modal-link-password.png)
...
![Public analytics dashboard with password protection enabled](https://assets.dub.co/help/share-dashboard-password.png)
