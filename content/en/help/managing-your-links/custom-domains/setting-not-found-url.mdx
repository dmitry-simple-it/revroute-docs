...
description: "Learn more about how you can set a custom not found URL for your domains on Dub."
...
![Placeholder 404 page on Dub](https://assets.dub.co/changelog/not-found-support.jpg)

If you are [using a custom domain on Dub](/help/managing-your-links/custom-domains/how-to-add-custom-domain), you can set a custom URL to redirect users to when a short link under your domain is not found.
