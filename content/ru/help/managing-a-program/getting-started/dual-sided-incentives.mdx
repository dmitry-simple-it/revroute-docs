...
С [Revroute Partners](https://dub.co/partners) вы можете создавать двусторонние стимулы для ваших партнерских/реферальных программ, которые предоставляют специальные скидки клиентам, зарегистрировавшимся по реферальной ссылке.
...
<CheckList>
  ...
  >
    Чтобы настроить двусторонние стимулы в Revroute Partners, сначала необходимо
...
dub_client = ::OpenApiSDK::Revroute.new
