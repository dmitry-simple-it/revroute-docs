...
You can also import your existing links into Dub via our CSV import feature. This is useful if you have a large list of links to import or if you want to [import links from another provider](/help/managing-your-links/migration-guides/migrating-from-bitly) that we don't have a 1-click importer for.
...
If you haven't already, [create a workspace on Dub](/help/managing-your-workspace/what-is-a-workspace).
