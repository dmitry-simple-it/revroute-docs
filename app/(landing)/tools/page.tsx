...
const TOOLS = [
  ...
  },
  {
    ...
    icon: 'qr-code',
    description:
      'QR-код под любую ссылку прямо в браузере: свои цвета, логотип в центре, рамка с подписью, скачивание в PNG или SVG. Код статический — URL зашит внутрь картинки и после печати не меняется.',
    limits: ['PNG и SVG', 'Без статистики сканов'],
  },
  {
    name: 'Красивая ссылка на своём домене',
    href: '/tools/krasivaya-ssylka',
    icon: 'globe',
    description:
      'Сократите ссылку без регистрации — а в аккаунте подключите свой домен, чтобы короткие ссылки выглядели как go.вашбренд.ru, а не как адрес чужого сервиса. Свой домен доступен уже на бесплатном тарифе.',
    limits: ['Сокращатель — без регистрации', 'Свой домен — на Free'],
  },
  {
