...
og:title: "Как настроить атрибуцию по диплинкам в Dub"
description: "Узнайте, как использовать атрибуцию по диплинкам для отслеживания событий конверсий в Dub."
---
...
<Note>
  ...
  plan](https://dub.co/pricing/partners) или выше.
</Note>

Мощная [платформа атрибуции](/docs/concepts/attribution) Dub позволяет понять, насколько эффективно ваши диплинки конвертируются в реальных пользователей и доход внутри вашего приложения.
...
Затем вам потребуется сгенерировать [публичный ключ](/docs/api-reference/authentication#publishable-keys) в вашем рабочем пространстве Dub для отслеживания конверсий на стороне клиента.
...
Установите [Dub React Native SDK](/docs/sdks/client-side-mobile/installation-guides/react-native) и инициализируйте его с вашим публичным ключом и доменом коротких ссылок.
...
Установите [Dub iOS SDK](/docs/sdks/client-side-mobile/installation-guides/swift) и инициализируйте его с вашим публичным ключом и доменом коротких ссылок.
