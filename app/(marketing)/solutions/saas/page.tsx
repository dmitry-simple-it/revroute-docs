...
const faqItems = [
  ...
  },
  {
    ...
    a: 'Нативная интеграция с YooKassa: подключаете биллинг — события подписки (новая, продление, отмена) автоматически передаются в атрибуцию. Также есть открытый REST API для других платёжных систем.',
  },
  {
        ...
        sections: [
          {
            ...
            features: [
              ...
              { title: 'YooKassa', desc: 'Подключите биллинг — конверсии считаются сами.' },
