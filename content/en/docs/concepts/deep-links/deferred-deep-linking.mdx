...
5. Your app calls the `/track/open` endpoint with the `deepLink` parameter in the request body either directly or via a supported RevRoute Mobile SDK.
...
4. After installation, your app calls the `/track/open` endpoint with the `dubDomain` parameter in the request body either directly or via a supported RevRoute Mobile SDK .
