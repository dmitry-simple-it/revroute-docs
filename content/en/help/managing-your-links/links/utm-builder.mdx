...
To make it easier to add UTM parameters to your links, Revroute provides a UTM builder that allows you to easily populate UTM parameters for your links. Here's a live demo that you can play around with.
...
[Read the guide on how to create UTM templates](/help/managing-your-links/links/how-to-create-utm-templates) or try out the demo here.
