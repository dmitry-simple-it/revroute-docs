---
title: "Быстрый старт"
og:title: "Revroute Deep Links – Quickstart"
og:image: "https://s3.revroute.ru/dub-public/assets/cms/deep-links.jpg"
...
## Step 2: Create your deep links on Revroute
...
Go to your [Revroute dashboard](https://app.revroute.ru) and click **Create Link** in the top navigation bar.
...
<Tip>
  This step is optional. If you don't enter a short link slug, Revroute will generate
  a random 7-character slug for you.
</Tip>

### Add device targeting

[Device Targeting](/help/managing-your-links/links/device-targeting) enables you to redirect users to the App Store or Google Play Store if your app isn’t installed.
...
<Note>
  Revroute's link builder offers many additional features like UTM builder, password
  protection, expiration dates, geo targeting, and more. [Learn more about
  creating links on Revroute](/help/managing-your-links/links/how-to-create-link) to explore all
  available options.
</Note>
...
**Option 1**: Handle the deep link using a supported [Revroute Mobile SDK](/docs/sdks/client-side-mobile/introduction) (iOS & React Native only)
...
Once you’ve detected and parsed the deep link, you should track the open event using Revroute's API, which will return the final destination URL in the API response.
...
When your app isn't installed, the user will be redirected to the App Store or Google Play Store since you've enabled [device targeting](/help/managing-your-links/links/device-targeting) in Step 2 above.
...
When a third-party service wraps your Revroute link in their own tracking URL, the deep link won't work because the device sees the wrapper domain instead of your allowlisted domain.

Contact your marketing or analytics provider to ensure Revroute links are passed through without modification.
