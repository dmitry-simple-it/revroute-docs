...
description: "Узнайте, как использовать Dub для создания диплинков для вашего мобильного приложения (с нативной поддержкой React Native, iOS и Android)."
---
...
В Dub вы можете создавать диплинки, позволяющие перенаправлять пользователей на определённую страницу вашего мобильного приложения.

![Deep links on Dub](https://assets.dub.co/cms/deep-links.jpg)
...
## Шаг 1: Настройте домены диплинков в Dub

Прежде чем создавать диплинки, необходимо настроить домены диплинков в вашем рабочем пространстве Dub. Для этого нужно добавить пользовательский домен, который будет использоваться для диплинков, и настроить конфигурационные файлы диплинков.

### Добавление пользовательского домена

Сначала необходимо добавить пользовательский домен в ваше рабочее пространство Dub. Перейдите в [настройки доменов рабочего пространства](https://app.dub.co/settings/domains) и нажмите **Add Domain**.
...
После настройки пользовательского домена необходимо загрузить конфигурационные файлы диплинков в Dub, которые мы будем размещать в директории `/.well-known/` вашего домена.
...
<Note>
  ...
  creating links on Dub](/help/managing-your-links/links/how-to-create-link) to explore all
  available options.
</Note>
