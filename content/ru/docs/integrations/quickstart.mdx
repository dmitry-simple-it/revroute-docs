...
og:title: "Как создать собственную интеграцию с Revroute"
...
<Steps>
  ...
  <Step title="Выполните API-запрос с токеном доступа">
    ...
    Вы можете инициализировать [SDK Revroute](/docs/sdks/overview) с токеном доступа.

    Вот пример создания ссылки с помощью [TypeScript SDK Revroute](/docs/sdks/typescript):
