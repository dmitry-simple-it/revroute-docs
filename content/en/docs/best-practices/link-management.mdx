...
A branded domain earns more trust than a generic one and usually gets more clicks. The DNS setup is one CNAME + a TXT — see [Domain config troubleshooting](/docs/troubleshooting/domain-config) if SSL doesn't provision.
