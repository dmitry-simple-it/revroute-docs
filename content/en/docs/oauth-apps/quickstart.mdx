...
```json
{
  "access_token": "rr_access_token_xxx",
  "token_type": "Bearer",
  "expires_in": 7200,
  "refresh_token": "yyy",
  "scope": "links.read links.write analytics.read"
...
curl https://api.revroute.ru/links \
  -H "Authorization: Bearer rr_access_token_xxx"
```
